...
import AllocatedEmployeeTable from "./AllocatedEmpTable";
  ...
  return (
    <>
      ...
      <div className="container text-center pt-5">
        ...
        <div className="mb-4">
          <h6>Total No. of employees, you allocated a batch to :{" " + no}</h6>
        </div>
        ...
        <AllocatedEmployeeTable />
      </div>
    </>
  );
};

export default AllocatedEmployees;
